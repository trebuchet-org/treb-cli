...
func TestMultichainDeployment(t *testing.T) {
	helpers.IsolatedTest(t, "multichain_deployment", func(t *testing.T, ctx *helpers.TrebContext) {
...
func mustExtractAddress(t *testing.T, ctx *helpers.TrebContext) string {
