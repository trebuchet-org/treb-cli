...
// InternalManager manages anvil instances without pkg dependencies
type InternalManager struct{}

// NewInternalManager creates a new internal anvil manager
func NewInternalManager() *InternalManager {
	return &InternalManager{}
}

// Start starts an anvil instance
func (m *InternalManager) Start(ctx context.Context, instance *domain.AnvilInstance) error {
	// Set defaults
	if instance.Name == "" {
		instance.Name = "anvil"
	}
...
func (m *InternalManager) Stop(ctx context.Context, instance *domain.AnvilInstance) error {
	// Set file paths
	m.setFilePaths(instance)
...
func (m *InternalManager) GetStatus(ctx context.Context, instance *domain.AnvilInstance) (*domain.AnvilStatus, error) {
	// Set file paths
	m.setFilePaths(instance)
...
func (m *InternalManager) StreamLogs(ctx context.Context, instance *domain.AnvilInstance, writer io.Writer) error {
	// Set file paths
	m.setFilePaths(instance)
...
func (m *InternalManager) setFilePaths(instance *domain.AnvilInstance) {
	if instance.Name == "" {
		instance.Name = "anvil"
	}
	if instance.Port == "" {
...
func (m *InternalManager) isRunning(instance *domain.AnvilInstance) bool {
	pid, err := m.readPidFile(instance)
	if err != nil {
		return false
	}
...
func (m *InternalManager) readPidFile(instance *domain.AnvilInstance) (int, error) {
...
func (m *InternalManager) writePidFile(instance *domain.AnvilInstance, pid int) error {
	return os.WriteFile(instance.PidFile, []byte(strconv.Itoa(pid)), 0644)
}

// deployCreateX deploys the CreateX factory
func (m *InternalManager) deployCreateX(instance *domain.AnvilInstance) error {
...
func (m *InternalManager) fetchCreateXBytecode() (string, error) {
...
func (m *InternalManager) checkRPCHealth(instance *domain.AnvilInstance) error {
	req := rpcRequest{
		Jsonrpc: "2.0",
...
func (m *InternalManager) checkCreateXDeployment(instance *domain.AnvilInstance) error {
	req := rpcRequest{
		Jsonrpc: "2.0",
		Method:  "eth_getCode",
		Params:  []interface{}{CreateXAddress, "latest"},
...
func (m *InternalManager) makeRPCCall(instance *domain.AnvilInstance, req rpcRequest) error {
	var resp rpcResponse
	return m.makeRPCCallWithResponse(instance, req, &resp)
}

// makeRPCCallWithResponse makes an RPC call and parses the response
func (m *InternalManager) makeRPCCallWithResponse(instance *domain.AnvilInstance, req rpcRequest, resp *rpcResponse) error {
	jsonData, err := json.Marshal(req)
	if err != nil {
		return err
	}
