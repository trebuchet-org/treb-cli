...
// InternalLibraryResolver resolves deployed libraries without pkg dependencies
type InternalLibraryResolver struct {
	deploymentStore usecase.DeploymentStore
}

// NewInternalLibraryResolver creates a new internal library resolver
func NewInternalLibraryResolver(deploymentStore usecase.DeploymentStore) *InternalLibraryResolver {
	return &InternalLibraryResolver{
		deploymentStore: deploymentStore,
	}
}

// GetDeployedLibraries gets all deployed libraries for the given context
func (r *InternalLibraryResolver) GetDeployedLibraries(
	ctx context.Context,
	namespace string,
	chainID uint64,
