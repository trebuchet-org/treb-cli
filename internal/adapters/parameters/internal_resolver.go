...
// InternalResolver handles parameter resolution without pkg dependencies
...
// NewInternalResolver creates a new internal parameter resolver
func NewInternalResolver(
	cfg *config.RuntimeConfig,
	deploymentStore usecase.DeploymentStore,
	contractIndexer usecase.ContractIndexer,
) *InternalResolver {
...
func (r *InternalResolver) ResolveParameters(
	ctx context.Context,
...
func (r *InternalResolver) ValidateParameters(
	ctx context.Context,
	params []domain.ScriptParameter,
	values map[string]string,
) error {
...
func (r *InternalResolver) resolveParameter(
	ctx context.Context,
...
func (r *InternalResolver) resolveSender(ctx context.Context, name string) (string, error) {
...
func (r *InternalResolver) resolveDeployment(ctx context.Context, name string, existingValues map[string]string) (string, error) {
...
func (r *InternalResolver) resolveArtifact(ctx context.Context, name string) (string, error) {
	// Search for contracts matching the name
	contracts := r.contractIndexer.SearchContracts(ctx, name)
...
func (r *InternalResolver) resolveFromConfig(name string) (string, error) {
