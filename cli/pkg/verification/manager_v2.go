...
type ManagerV2 struct {
	registryManager *registryv2.Manager
	networkResolver *network.Resolver
}

func NewManagerV2(registryManager *registryv2.Manager, networkResolver *network.Resolver) *ManagerV2 {
	return &ManagerV2{
...
func (vm *ManagerV2) VerifyDeployment(deployment *types.Deployment) error {
...
func (vm *ManagerV2) VerifyDeploymentWithDebug(deployment *types.Deployment, debug bool) error {
...
func (vm *ManagerV2) verifyOnEtherscanWithDebug(deployment *types.Deployment, networkInfo *network.NetworkInfo, debug bool) error {
...
func (vm *ManagerV2) verifyOnSourceifyWithDebug(deployment *types.Deployment, networkInfo *network.NetworkInfo, debug bool) error {
	// Get contract path from artifact
	contractPath := deployment.Artifact.Path
	if deployment.Metadata != nil && deployment.Metadata.ContractPath != "" {
		// Override with manual contract path if provided
...
func (vm *ManagerV2) buildEtherscanURL(networkInfo *network.NetworkInfo, address string) string {
...
func (vm *ManagerV2) buildSourceifyURL(networkInfo *network.NetworkInfo, address string) string {
...
func (vm *ManagerV2) updateOverallStatus(deployment *types.Deployment) {
	if deployment.Verification.Verifiers == nil {
